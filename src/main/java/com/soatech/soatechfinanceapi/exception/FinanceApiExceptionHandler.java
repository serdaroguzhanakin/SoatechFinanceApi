package com.soatech.soatechfinanceapi.exception;

import com.soatech.soatechfinanceapi.model.entity.RestApiError;
...
@ControllerAdvice
public class FinanceApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleGenericApiExceptions(FinanceApiException ex) {
